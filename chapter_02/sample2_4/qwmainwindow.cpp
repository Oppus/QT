...
/*void QWMainWindow::updateCurFile(QString aFile);
{
...
void QWMainWindow::iniUI()
{
    ...
    ui->statusBar->addWidget(fLabCurFile);//将文件名添加到状态栏

    progressBar1 = new QProgressBar;//状态栏上的进度条
    progressBar1->setMaximumWidth(200);//设置组件最大宽度
    progressBar1->setMinimum(5);
    progressBar1->setMaximum(50);
    //font()返回data->fnt,fnt为QFont类型的对象
    //pointSize()是QFont的成员函数
    ...
    ui->mainToolBar->addSeparator();//工具栏上增加分隔线
...
void QWMainWindow::on_actFontUnderline_triggered(bool checked)
{
    QTextCharFormat fmt;
    fmt = ui->txtEdit->currentCharFormat();
...
{
    //当前选择的文字发生变化，更新粗体、斜体、下划线3个action的check状态
    QTextCharFormat fmt;
